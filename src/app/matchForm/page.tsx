    ...
    <div className="from-slate-50 relative min-h-screen overflow-hidden bg-gradient-to-br via-blue-50 to-indigo-100">
      ...
      <div className="relative flex min-h-screen w-full items-center justify-center p-4">
        <div className="w-full max-w-lg">
          <div className="rounded-3xl bg-white/80 p-8 text-center shadow-2xl backdrop-blur-sm md:p-12">
            <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-teal-500 to-yellow-100 shadow-lg md:mb-8 md:h-20 md:w-20">
              <svg
            ...
            <div className="mt-8 flex flex-col items-center gap-3">
              <RedirectButton
                label="Back to your match forms"
